...
import { Formula } from '../pages/calculos/formulas';


const TablePerPercentage = ({ sexo, peso, talla, edad, factor, formula }: { sexo: any, peso: any, talla: any, edad: any, factor: any, formula: any }) => {
